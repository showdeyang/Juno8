...
from PyQt6.QtWidgets import QApplication, QMainWindow, QWidget, QPushButton, QLabel, QComboBox, QTableWidget, QTableWidgetItem, QFileDialog, QFormLayout, QVBoxLayout, QHBoxLayout, QTabWidget, QTextEdit, QTextBrowser, QDateEdit, QHeaderView
...
class JunoUI(object):
    ...
    def Main_Window(self, juno):
        ...
        self.project_table.horizontalHeader()
    ...
    def load_project_table(self):
        ...
        for i in load_project_sort:
            ...
            item.setFlags(QtCore.Qt.ItemFlags.ItemIsSelectable | QtCore.Qt.ItemFlags.ItemIsEnabled)
            item.setTextAlignment(QtCore.Qt.Alignment.AlignCenter)
    ...
    def config_window(self, project_name, juno, *task_name_1):
        ...
        self.situation_table.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)    #  .setSectionResizeMode(QHeaderView.Stretch)
...
if __name__ == '__main__':
    ...
    # app.setAttribute(QtCore.Qt.ApplicationAttribute.AA_NativeWindows)
    app.setStyle('Fusion')
